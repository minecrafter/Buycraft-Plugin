                    ...
                    public void run() {
                        try {
                            ...
                            if (apiResponse.getInt("code") == 0) {
                                ...
                                if(plugin.getSettings().getBoolean("isBungeecord") && !requiresOnlineMode){
                                    plugin.getLogger().warning("This server must have an online mode webstore in order to use Bungeecord");
                                    return;
                                }
